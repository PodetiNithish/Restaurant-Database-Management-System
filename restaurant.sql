...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 9, 2022 at 01:53 PM
...
(136, 15, 1, '2022-12-07'),
(137, 55, 1, '2022-12-07'),
(138, 65, 12, '2022-12-07'),
(139, 25, 1242, '2022-12-07'),
(140, 40, 1243, '2022-12-07'),
(141, 15, 1243, '2022-12-07'),
(142, 45, 1244, '2022-12-07'),
(1423, 60, 2, '2022-12-18');
...
(123, 'Varsha reddy', 'headchef', '12345', 'varsha@gmail.com', 'C 103 siddamshetty towers, Nea', '2147483647'),
(130, 'Nithish', 'Nitthu', '123456', 'nitthu@gmail.c', 'Jawahar Nagar, Rtc X Roads', '2147483647'),
(131, 'gordan ramsay', 'ramsay', '1234', 'nitthuuu@gmail.com', 'earth, 20210', '123453782');
...
(1, 'nithish', 'aa@gmail.com', '24 lawn st', 'nithishgoud', '123456', '2000-03-11', '1234568888'),
(2, 'varsha', 'a@gmail.com', '24 lawn st', 'varshareddy', '123', '2000-03-11', '1234567899'),
...
(1245, 'Charan chavvareddy', 'cha@gmail.com', 'Tremont street, Boston', 'charan', 'charan123', '1999-03-08', '123456'),
(1247, 'sumesh reddy', 'sum@gmail.com', 'Tremont street, Boston', 'sumesh', 'sumesh123', '1998-01-10', '12345654'),
(1248, 'pranjali agar', 'praj@gmail.com', 'tremont street, boston', 'pranjali', 'pranjali123', '1998-02-02', '122468455');
...
INSERT INTO `employes` (`id`, `Name`, `address`, `Phone`, `ManagerID`, `CustID`) VALUES
(3, 'Ram', 'lawn st', '8578672869', NULL, NULL),
(12, 'RAHUL', 'Jawahar Nagar, Rtc X Roads, C-103 Siddamshetty Towers', '07680887111', NULL, NULL);
...
(1, 'varsha', 'admin', '123456', 'var@gmail.com', '123 tremont st, boston', NULL);
...
(18, 'Fried wings', 'Chicken hot wings fried in oil with marinated spices', 10);
...
(123, 1, 123, 1, '2022-11-13', 2, 'not done');
...
(7, 1, 123, 1, '2022-11-18', 'not done'),
(8, 2, 123, 1, '2022-11-18', 'not done'),
(9, 12, 123, 1, '2022-11-18', 'done'),
(10, 12, 123, 3, '2022-11-18', 'not done'),
(12, 12, 123, 1, '2022-11-18', 'not done'),
(13, 1, 123, 1, '2022-11-18', 'done'),
(14, 1, 123, 1, '2022-11-18', NULL),
(15, 1, 123, 1, '2022-11-18', NULL),
(16, 1, 123, 3, '2022-11-18', NULL),
(18, 1, 123, 1, '2022-11-18', NULL),
(19, 1, 123, 3, '2022-11-18', NULL),
(21, 1, 123, 1, '2022-11-18', NULL),
(22, 1, 123, 3, '2022-11-18', NULL),
(24, 1, 123, 1, '2022-11-18', NULL),
(25, 1, 123, 3, '2022-11-18', NULL),
(27, 1, 123, 1, '2022-11-18', NULL),
(28, 1, 123, 3, '2022-11-18', NULL),
(29, 1, 123, 1, '2022-11-18', 'done'),
(30, 2, 123, 1, '2022-11-18', NULL),
(31, 2, 123, 3, '2022-11-18', 'not done'),
(32, 2, 123, 1, '2022-11-18', NULL),
(33, 1240, 123, 3, '2022-11-18', 'not done'),
(34, 1, 123, 3, '2022-11-19', NULL),
(35, 1, 130, 1, '2022-11-19', 'done'),
(36, 1, 123, 1, '2022-12-11', 'done'),
(37, 1, 131, 13, '2022-12-03', NULL),
(38, 1, 130, 13, '2022-12-03', NULL),
(39, 1, 123, 13, '2022-12-03', 'not done'),
(40, 1, 130, 1, '2022-12-03', NULL),
(43, 1, 131, 1, '2022-12-03', 'done'),
(44, 1, 123, 1, '2022-12-03', NULL),
(46, 1, 131, 3, '2022-12-03', 'not done'),
(47, 1, 131, 13, '2022-12-03', NULL),
(48, 1, 130, 3, '2022-12-03', NULL),
(49, 1, 131, 13, '2022-12-03', NULL),
(50, 1, 130, 1, '2022-12-06', NULL),
(51, 1, 130, 14, '2022-12-06', NULL),
(53, 2, 123, 3, '2022-12-06', NULL),
(54, 1, 131, 1, '2022-12-06', 'not done'),
(55, 1, 130, 3, '2022-12-06', NULL),
(56, 1, 130, 1, '2022-12-07', NULL),
(57, 1, 130, 1, '2022-12-07', NULL),
(58, 1, 130, 14, '2022-12-07', NULL),
(60, 12, 131, 3, '2022-12-07', 'done'),
(61, 12, 123, 14, '2022-12-07', 'not done'),
(62, 12, 123, 3, '2022-12-07', 'not done'),
(63, 12, 131, 1, '2022-12-07', 'done'),
(64, 1242, 130, 3, '2022-12-07', 'not done'),
(65, 1242, 123, 1, '2022-12-07', 'not done'),
(66, 1242, 123, 3, '2022-12-07', 'done'),
(67, 1243, 130, 14, '2022-12-07', 'not done'),
(68, 1243, 130, 1, '2022-12-07', 'not done'),
(69, 1244, 123, 3, '2022-12-07', 'not done'),
(70, 1244, 131, 14, '2022-12-07', 'not done');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `login_chef`  AS SELECT `chef`.`username` AS `username`, `chef`.`password` AS `password` FROM `chef``chef`  ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `login_cust`  AS SELECT `customer`.`id` AS `id`, `customer`.`username` AS `username`, `customer`.`password` AS `password` FROM `customer``customer`  ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `login_manager`  AS SELECT `manager`.`username` AS `username`, `manager`.`password` AS `password` FROM `manager``manager`  ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `max1`  AS SELECT `bill`.`Customerid` AS `Customerid`, count(`bill`.`Customerid`) AS `count1` FROM `bill` GROUP BY `bill`.`Customerid``Customerid`  ;
...
ALTER TABLE `employes`
  ...
  ADD KEY `FK_manEmp` (`ManagerID`),
  ADD KEY `FK_EmpCust` (`CustID`);
...
ALTER TABLE `inventorydetails`
  ...
  ADD KEY `FK_MGR` (`managerID`),
  ADD KEY `FK_INV` (`inventoryID`);
...
ALTER TABLE `reservation_table`
  ...
  ADD KEY `FKCustReser` (`Customerid`);
...
--
ALTER TABLE `customer`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1249;
...
--
ALTER TABLE `employes`
  ADD CONSTRAINT `FK_EmpCust` FOREIGN KEY (`CustID`) REFERENCES `customer` (`Name`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_manEmp` FOREIGN KEY (`ManagerID`) REFERENCES `manager` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `inventorydetails`
  ADD CONSTRAINT `FK_INV` FOREIGN KEY (`inventoryID`) REFERENCES `inventory` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_MGR` FOREIGN KEY (`managerID`) REFERENCES `manager` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `reservation_table`
  ADD CONSTRAINT `FKCustReser` FOREIGN KEY (`Customerid`) REFERENCES `customer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FKReservatio145134` FOREIGN KEY (`ReservationDate`) REFERENCES `reservation` (`Date`);

--
-- Constraints for table `reservaton_wait`
--
ALTER TABLE `reservaton_wait`
  ADD CONSTRAINT `FK_custRW` FOREIGN KEY (`Customerid`) REFERENCES `customer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
